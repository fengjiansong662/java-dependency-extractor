...
public class RevisedHeatChart {
	...
	public RevisedHeatChart(double[][] zValues) {
	...
	public RevisedHeatChart(double[][] zValues, double low, double high) {
	...
	public Image getChartImage(boolean alpha) {
		...
		drawChartOnGraphicsObject(chartGraphics);
		
		return chartImage;
	}

	protected void drawChartOnGraphicsObject(Graphics2D chartGraphics) {
