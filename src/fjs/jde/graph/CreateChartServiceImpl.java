...
public class CreateChartServiceImpl
{
	...
	public void makeLineAndShapeChart()
	{
		...
		String[] columnKeys =
		{ "as.jcge.db.DatabaseConnector", "as.jcge.bugs.npe.MockGitController", "as.jcge.output.QueueWorker", "as.jcge.ast.Visitor", "as.jcge.main.Resources" };
	...
	public void makeBarGroupChart()
	{
		double[][] data = new double[][]
		{
		{ 672, 766, 223, 540, 126,672, 766, 223, 540, 126 },
		{ 325, 521, 210, 340, 106,325, 521, 210, 340, 106 },
		{ 332, 256, 523, 240, 526,332, 256, 523, 240, 526 } };
		String[] rowKeys =
		{ "苹果", "梨子", "葡萄" };
		String[] columnKeys =
		{ "北京", "上海", "广州", "成都", "深圳","被","上","广","程度","啊"};
		CategoryDataset dataset = getBarData(data, rowKeys, columnKeys);
