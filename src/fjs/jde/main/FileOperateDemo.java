...
public class FileOperateDemo {
	...
	private static boolean copyFile(String srcPath, String destDir) {
		...
		String destDirfileName1 = destDir.substring(destDir.indexOf(File.separator));
		String destPath = destDirfileName1+fileName;
	...
	public static void main(String[] args) {
		//copyGeneralFile("E:\\Assemble.txt", "E:\\xinjian"); // 复制文件
		//copyGeneralFile("E:\\xinjian", "E:\\world"); // 复制文件夹
		//deleteGeneralFile("E:\\xinjian\\Assemble.txt"); // 删除文件
		deleteGeneralFile("E:\\world\\Radio"); // 删除文件夹
		//cutGeneralFile("E:\\DBScan03\\Radio", "E:\\world"); // 剪切文件夹
		//cutGeneralFile("E:\\Assemble.txt", "E:\\world"); // 剪切文件
